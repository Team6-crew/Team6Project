...
//#endif
//
//	float scalar = m_TexWidth / WindowFactory::Instance()->GetWindow()->GetScreenSize().x;
//
//	glBindFramebuffer(GL_FRAMEBUFFER, m_glPickerFBO);
...
//
//	//	Vector2 mousepos;
//	//	bool mouseInWindow = WindowFactory::Instance()->GetWindow()->GetMouseScreenPos(&mousepos);
//	//	mousepos.y = WindowFactory::Instance()->GetWindow()->GetScreenSize().y - mousepos.y; //Flip Y as opengl uses bottom left as origin
//
//	//	Vector3 clipspacepos = Vector3(
//	//		mousepos.x / (WindowFactory::Instance()->GetWindow()->GetScreenSize().x * 0.5f) - 1.0f,
//	//		mousepos.y / (WindowFactory::Instance()->GetWindow()->GetScreenSize().y * 0.5f) - 1.0f,
//	//		0.0f);
//
//
//	//	bool mouseDown = OGLWindow::GetMouse()->ButtonDown(MOUSE_LEFT) || OGLWindow::GetMouse()->ButtonDown(MOUSE_RIGHT);
//	//	bool mouseHeld = OGLWindow::GetMouse()->ButtonHeld(MOUSE_LEFT) || OGLWindow::GetMouse()->ButtonHeld(MOUSE_RIGHT);
//
//	//	//Do we have an object already being dragged?
//	//	if (m_pCurrentlyHeldObject != NULL)
//	//	{
//	//		if (OGLWindow::GetMouse()->GetWheelMovement() != 0)
//	//		{
...
//
//	//			oldDepthWS += OGLWindow::GetMouse()->GetWheelMovement();
//
...
//
//		WindowFactory::Instance()->GetWindow()->SetCursorStyle(CURSOR_STYLE_GRAB);
//	}
//}
//
...
//		m_pCurrentlyHoverObject = NULL;
//*/
//		WindowFactory::Instance()->GetWindow()->SetCursorStyle(CURSOR_STYLE_DEFAULT);
//	}
//}
//
...
//	Vector2 mousepos;
//	if (m_pCurrentlyHeldObject != NULL || !WindowFactory::Instance()->GetWindow()->GetMouseScreenPos(&mousepos))
//	{
//		return;
//	}
//	mousepos.y = WindowFactory::Instance()->GetWindow()->GetScreenSize().y - mousepos.y;
//
//	//Setup Shader
