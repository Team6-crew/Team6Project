...
{   
	...
	//ball->Physics()->SetOnCollisionCallback(
	//	std::bind(&Player::CallbackFunction,
	//		this,
	//		std::placeholders::_1,
	//		std::placeholders::_2));
...
void Player::move() {
	...
	if (Window::GetKeyboard()->KeyDown(move_right))
	{
   	...
   	if ((Window::GetKeyboard()->KeyDown(move_jump))&&(canjump==1))
	{
		ball->Physics()->SetForce(jump * speed);
	}
...
//bool Player::CallbackFunction(PhysicsNode* self, PhysicsNode* collidingObject)
//{
//	if (collidingObject->GetParent() != nullptr)
//	{
//		if (collidingObject->GetParent()->GetName() == "Ground")
//		{
//			canjump = 1;
//		}
//	}
